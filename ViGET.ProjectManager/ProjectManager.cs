...
namespace DothanTech.ViGET.Manager
{
    ...
    /// ViGET 工程数据管理器。
    /// </summary>
    public partial class ProjectManager : ViFolderInfo, IDisposable
    {
        ...
        /// 工程文件所在的路径名称，以 \ 结尾。
        /// </summary>
        public string ProjectPath { get { return this.DirectoryPath; } }
        ...
        /// 工程的 GEN 目录。
        /// </summary>
        public string ProjectGenPath
        {
            get
            {
                return FileName.GetAbsoluteFileName(this.ProjectPath, this.OutputPath);
            }
        }
        ...
        public string LibrariesBackup
        {
            get
            {
                return this.ProjectPath + "Libraries";
            }
        }
