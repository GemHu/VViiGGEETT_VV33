...
/// <summary>
/// 所有 ViGET 编辑器相关对象的命名空间。
/// </summary>
namespace DothanTech
{
}
...
namespace Dothan.ViObject
{
    ...
    public abstract class ViObject : DependencyObject, IViPropertyChanged, IDisposable
    {
        ...
        public static readonly DependencyProperty TypeProperty =
            DependencyProperty.Register("Type", typeof(Object), typeof(ViObject),
        ...
        public ViObject GetAncestor(System.Type type)
        {
            ...
            if (type.Equals(this.Parent.GetType()))
                return this.Parent;
            if (type.IsAssignableFrom(this.Parent.GetType()))
                return this.Parent;
            if (this.Parent.GetType().IsSubclassOf(type))
                return this.Parent;
